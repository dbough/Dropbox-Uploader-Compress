...
# All of our work is done here.  Compress, then backup to dropbox, then remove the local compressed file.
if ( $compress ) {
...
sub readme{
    ...
    print "Example:  ./db_uploader_wrapper.pl --bu_source_file='bigfile.txt' --bu_source_path='/home/yourname/' --backup_target_folder='Backups' --script_path='/usr/sbin/' --compress\n\n";
